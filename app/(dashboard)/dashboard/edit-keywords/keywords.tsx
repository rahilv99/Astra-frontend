...
export function EditKeywords() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-lg rounded-lg shadow-md p-6 bg-white bg-opacity-10 rounded-xl p-8 backdrop-filter backdrop-blur-lg">
        <h1 className="text-2xl font-semibold text-white mb-4">Edit Keywords</h1>
