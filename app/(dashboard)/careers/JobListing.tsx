...
export function JobListing({ title, qualifications }: JobListingProps) {
  ...
  return (
    <div className="bg-gray-700 bg-opacity-10 rounded-lg p-6 space-y-4 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
      ...
      {isExpanded && (
        <div className="mt-4 space-y-2 bg-gray-500 bg-opacity-5 p-4 rounded-lg">
