...
let  users:User[] = [
    {
      ...
      passwordHash: await hashPassword("testone@test.com"), // Precompute or provide a default hash,
      role: "other",
      stripeCustomerId: "",
    ...
    },
    {
        ...
        passwordHash: await hashPassword("testtwo@test.com"), // Precompute or provide a default hash,
        role: "other",
        stripeCustomerId: "",
        stripeSubscriptionId: "",
        stripeProductId: "",
